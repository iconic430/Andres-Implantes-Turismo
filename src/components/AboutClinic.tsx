      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center" id="about-content">
          ...
          <div className="lg:col-span-5 relative" id="about-image-col">
            ...
            <div className="rounded-[2.5rem] border-8 border-slate-50 shadow-xl overflow-hidden aspect-[4/5] bg-slate-50 relative">
              <img
                src="https://i.postimg.cc/BQ5pH2Mm/Whats-App-Image-2026-07-14-at-14-16-55.jpg"
